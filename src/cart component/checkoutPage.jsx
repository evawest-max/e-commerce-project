...
export default function Checkout() {
  ...
  const apiKey = process.env.REACT_APP_FLUTTERWAVE_API_KEY;
  // "FLWPUBK_TEST-cb119a9a9127ae014d8a8ddd16e081da-X";
  ...
  return (
    <div className="App">
      <div className="flex items-center space-x-2 p-4">
        <Link to="/cart" style={{color:"orangered"}} className="text-orange-500 flex justify-center items-center gap-3">
          <BiArrowBack />
      ...
      <div className="space-y-4 p-6">
        ...
        <button
          ...
          className="w-full bg-blue-500 text-orange-500 p-3 rounded-md hover:bg-blue-600 transition"
        >
          Pay
        </button>
        {successfully && <Navigate to="/cart" />}
      </div>
    </div>
  );
}
